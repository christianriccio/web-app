...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash("L'account è stato aggiornato", 'success')
...
def send_reset_email(user):
    ...
    msg = Message('Password reset request', sender='spsurveytest@gmail.com', recipients=[user.email])
    msg.body = f'''To reset your password visit the following link:
{url_for('reset_token', token = token, _external = True)}

If you did not make this request simply ignore the request and no changes will be made
 '''
    mail.send(msg)
